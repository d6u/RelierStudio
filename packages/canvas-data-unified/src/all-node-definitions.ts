import {
  ...
  JSONATA_CONDITIONS_NODE_FUNCTIONS,
  JSONATA_TRANSFORM_NODE_DEFINITION,
  JSONATA_TRANSFORM_NODE_FUNCTIONS,
  ...
  MUSTACHE_TEXT_TEMPLATE_NODE_FUNCTIONS,
...
export const NODE_DEFINITIONS = {
  ...
  [MUSTACHE_TEXT_TEMPLATE_NODE_DEFINITION.type]: MUSTACHE_TEXT_TEMPLATE_NODE_DEFINITION,
  ...
  [JSONATA_TRANSFORM_NODE_DEFINITION.type]: JSONATA_TRANSFORM_NODE_DEFINITION,
  [JSONATA_CONDITIONS_NODE_DEFINITION.type]: JSONATA_CONDITIONS_NODE_DEFINITION,
...
export const NODE_TYPES: NodeType[] = [
  ...
  MUSTACHE_TEXT_TEMPLATE_NODE_DEFINITION.type,
  JSON_PARSE_NODE_DEFINITION.type,
  JSON_TO_STRING_NODE_DEFINITION.type,
  JSONATA_TRANSFORM_NODE_DEFINITION.type,
  JSONATA_CONDITIONS_NODE_DEFINITION.type,
...
export const NODE_FUNCTIONS = {
  ...
  [MUSTACHE_TEXT_TEMPLATE_NODE_DEFINITION.type]: MUSTACHE_TEXT_TEMPLATE_NODE_FUNCTIONS,
  ...
  [JSONATA_TRANSFORM_NODE_DEFINITION.type]: JSONATA_TRANSFORM_NODE_FUNCTIONS,
  [JSONATA_CONDITIONS_NODE_DEFINITION.type]: JSONATA_CONDITIONS_NODE_FUNCTIONS,
