...
import {
  type JsonataConditionsNodeConfig,
  type JsonataConditionsNodeParams,
  createDefaultJsonataConditionsNodeConfig,
} from './node-definition';

export const JSONATA_CONDITIONS_NODE_FUNCTIONS: NodeFunctions<
...
> = {
  createDefaultCanvasData(context: CreateDefaultCanvasDataContext) {
    ...
    const nodeConfig = createDefaultJsonataConditionsNodeConfig({
      nodeId: nodeId,
